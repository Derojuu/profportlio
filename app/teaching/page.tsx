        ...
        <Container>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20">
            ...
            >
              ...
              <h2 className="text-brand-gold font-black text-xs tracking-wide mb-10 relative z-10">Undergraduate &amp; Graduate</h2>
            ...
            >
              <div className="flex justify-between items-center mb-10">
                <h2 className="text-brand-gold font-black text-xs tracking-wide">Postgraduate Supervision</h2>
              ...
              <div className="grid grid-cols-2 gap-8 mb-10">
                <div>
                  ...
                  <p className="text-xs font-black text-slate-400 tracking-wide">Alumni Supervised</p>
                </div>
                <div>
                  ...
                  <p className="text-xs font-black text-slate-400 tracking-wide">Current Students</p>
                </div>
              </div>
              ...
              <div className="pt-8 border-t border-slate-100 dark:border-white/5 space-y-8">
                <div>
                  <h3 className="text-xs font-black text-brand-gold tracking-wide mb-4">Completed (MSc/PhD)</h3>
                ...
                <div>
                  <h3 className="text-xs font-black text-brand-gold tracking-wide mb-3">Current (Main)</h3>
                  ...
                  <h3 className="text-xs font-black text-brand-gold tracking-wide mt-4 mb-3">Co-Supervisor</h3>
                  <ul className="space-y-2 text-sm text-brand-navy dark:text-slate-300">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            >
              ...
              <ul className="space-y-2 text-sm text-brand-navy dark:text-slate-400">
                {expertService.externalExaminerRoles.map((item, i) => (
                  <li key={i}>{item}</li>
                ))}
              </ul>
            </motion.div>
              ...
              <ul className="space-y-4 text-sm text-brand-navy dark:text-slate-400">
                {expertService.internationalPhDAssessed.map((p, i) => (
                  <li key={i}>
                    ...
                    <span className="text-xs text-slate-500 block">{p.university}, {p.year}</span>
                  </li>
                ))}
              </ul>
            </motion.div>
          ...
          >
            ...
            <div className="relative z-10 space-y-8">
              <div>
                <h3 className="text-xs font-black text-brand-gold tracking-wide mb-4">Editor roles</h3>
              ...
              <div>
                <h3 className="text-xs font-black text-brand-gold tracking-wide mb-4">Reviewer for (selected)</h3>
