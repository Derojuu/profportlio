          ...
          <div className="lg:col-span-8 p-12 rounded-[50px] bg-brand-navy dark:bg-brand-navy/60 text-white relative overflow-hidden group">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-10">
                ...
                <h3 className="text-3xl font-black uppercase tracking-tight">Key Contributions</h3>
              </div>
              ...
              <div className="mt-12 pt-8 border-t border-white/5 flex justify-between items-center">
                <p className="text-slate-400 text-xs font-bold uppercase tracking-widest">{contributionToKnowledge.highlights.length} documented contributions</p>
                <a href="/research" className="text-xs font-black text-brand-gold uppercase tracking-widest hover:underline">Explore all →</a>
              </div>
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div className="p-8 rounded-[40px] bg-white dark:bg-white/5 border border-slate-100 dark:border-white/5 flex-1 shadow-xl">
               <div className="flex justify-between items-center mb-6">
                 <h4 className="text-[10px] font-black text-brand-gold uppercase tracking-[0.4em]">In Progress</h4>
            ...
            <div className="p-8 rounded-[40px] bg-white dark:bg-white/5 border border-slate-100 dark:border-white/5 flex-1 shadow-xl">
               <div className="flex justify-between items-center mb-6">
                 <h4 className="text-[10px] font-black text-brand-gold uppercase tracking-[0.4em]">Collaborations</h4>
               ...
               <div className="flex items-end gap-2">
                 ...
                 <span className="text-[10px] font-bold text-slate-400 uppercase tracking-widest mb-1.5">Global Partners</span>
               </div>
            </div>
          </div>
        </div>
