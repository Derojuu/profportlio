      ...
      <Container>
        <div className="flex flex-col md:flex-row justify-between items-center gap-6 mb-16">
          <motion.div variants={organicReveal} initial="hidden" whileInView="visible" className="flex items-center gap-4">
            ...
            <h2 className="text-4xl font-black uppercase tracking-tighter text-brand-navy dark:text-white">Teaching & Mentorship</h2>
          </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 mb-20">
          ...
          <div className="p-10 rounded-[40px] bg-brand-navy dark:bg-brand-navy/60 text-white relative overflow-hidden group shadow-2xl">
            ...
            <h3 className="text-brand-gold font-black text-[10px] uppercase tracking-[0.4em] mb-10 relative z-10">Undergraduate & Graduate</h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
              <div>
                <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 mb-6">Undergraduate</h4>
              ...
              <div>
                <h4 className="text-xs font-black uppercase tracking-widest text-slate-400 mb-6">Graduate</h4>
                <ul className="space-y-4">
            ...
            <div className="mt-10 pt-8 border-t border-white/5 relative z-10">
              <a href="/teaching" className="text-[10px] font-black text-brand-gold uppercase tracking-[0.3em] hover:text-white transition-colors">View All Courses →</a>
            </div>
          </div>
          ...
          <div className="p-10 rounded-[40px] bg-white dark:bg-white/5 border border-slate-100 dark:border-white/10 shadow-xl flex flex-col justify-between">
            <div>
              <div className="flex justify-between items-center mb-10">
                <h3 className="text-brand-gold font-black text-[10px] uppercase tracking-[0.4em]">Postgraduate Supervision</h3>
            ...
            <div className="mt-10 pt-8 border-t border-slate-100 dark:border-white/5">
              <a href="/teaching" className="text-[10px] font-black text-brand-navy dark:text-brand-gold uppercase tracking-[0.3em] hover:underline">Full Supervision Record →</a>
            </div>
          </div>
        </div>
      </Container>
